...
public class home extends Application {
    ...
    Stage productsStage=new Stage(StageStyle.DECORATED);
    Stage customerStage=new Stage(StageStyle.DECORATED);
    Stage salesmanStage=new Stage(StageStyle.DECORATED);
    Stage supplierStage=new Stage(StageStyle.DECORATED);
    Stage reportStage=new Stage(StageStyle.DECORATED);
    ...
    ,"Reports","Dashboard","Stock","Supplier"};
    ...
    public void start(Stage primaryStage) {
        ...
        b10.setStyle("-fx-background-image: url('images/salesman_icon.jpg');-fx-background-size: cover;");
        ...
        b1.setOnAction((event) -> {
            ...
            co.start(customerStage);
        });
        b2.setOnAction((event) -> {
            salesman sa=new salesman();
            sa.start(salesmanStage); 
        });
        b6.setOnAction((event) -> {
         ...
         b10.setOnAction((event) -> {
            ...
            supp.start(supplierStage);
        });
          b9.setOnAction((event) -> {
           
            settings set=new settings();
            set.start(settingsStage);
        });
        b8.setOnAction((event) -> {
            products pro=new products();
            try {
                pro.start(productsStage);
